...
class WhereAreYouGoScreenTwo extends StatefulWidget {
  ...
  const WhereAreYouGoScreenTwo({super.key, required this.vehicleType});

  @override
  State<WhereAreYouGoScreenTwo> createState() => _WhereAreYouGoScreenTwoState();
}

class _WhereAreYouGoScreenTwoState extends State<WhereAreYouGoScreenTwo> {
  @override
